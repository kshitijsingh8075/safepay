...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full max-w-[420px] flex-col-reverse p-4",
      className
    )}
    {...props}
  />
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        "p-4 md:p-6 shadow-xl", // Add responsive padding and stronger shadow
        className
      )}
      {...props}
    />
